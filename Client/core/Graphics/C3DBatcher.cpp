...
C3DBatcher::C3DBatcher(CGraphics* graphics)
{
    m_pGraphics = graphics;
}

C3DBatcher::~C3DBatcher()
{
}

void C3DBatcher::OnDeviceCreate(IDirect3DDevice9* pDevice, float fViewportSizeX, float fViewportSizeY)
{
    m_pDevice = pDevice;
    // Cache matrices
