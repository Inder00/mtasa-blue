...
C2DBatcher::C2DBatcher(CGraphics* graphics)
{
    m_pGraphics = graphics;
    D3DXMatrixIdentity(&m_MatWorld);
}

C2DBatcher::~C2DBatcher()
{
}

void C2DBatcher::OnDeviceCreate(IDirect3DDevice9* pDevice, float fViewportSizeX, float fViewportSizeY)
{
    m_pDevice = pDevice;
    // Cache matrices
...
////////////////////////////////////////////////////////////////
//
// C2DBatcher::OnRenderTargetChange
//
//
//
////////////////////////////////////////////////////////////////
void C2DBatcher::OnChangingRenderTarget(uint uiNewViewportSizeX, uint uiNewViewportSizeY)
{
    // Flush dx draws
    Flush();
...
void C2DBatcher::UpdateMatrices(float fViewportSizeX, float fViewportSizeY)
{
