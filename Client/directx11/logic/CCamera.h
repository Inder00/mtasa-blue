...
public:
    ...
    void SetProjAttribs(Float32 NearClipPlane, Float32 FarClipPlane, Float32 AspectRatio, Float32 FOV, SURFACE_TRANSFORM SrfPreTransform, bool IsGL);
    ...
    void SetHandness(bool IsRightHanded) { m_fHandness = IsRightHanded ? +1.f : -1.f; }
