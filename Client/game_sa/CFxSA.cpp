...
using StoreShadowToBeRendered_t = int(__cdecl*)(char type, RwTexture* texture, CVector* pos, float x1, float y1, float x2, float y2, __int16 intensity, char r,
                                                char g, char b, float zDistance, char bDrawOnWater, float scale, void* shadowData,
...
bool CFxSA::AddShadow(eShadowType shadowType, CVector& vecPosition, CVector2D& vecOffset1, CVector2D& vecOffset2, SColor color, float fZDistance, bool bDrawOnWater, bool bDrawOnBuildings)
{
