...
COgre::COgre()
{
     ...
     Ogre::MaterialPtr* defaultMaterial = &Ogre::MaterialManager::getSingletonPtr()->create("default", "default");
     Ogre::Window* window = root->createRenderWindow("SA-MP 0.4.0", 1000, 500, false, &params);
