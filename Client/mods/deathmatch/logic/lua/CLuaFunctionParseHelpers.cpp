...
IMPLEMENT_ENUM_BEGIN(eSelectTool)
ADD_ENUM(SELECT_TOOL_BYVERTEXID, "byVertexId")
ADD_ENUM(SELECT_TOOL_BYPOLYGONID, "byPolygonId")
ADD_ENUM(SELECT_TOOL_NEAREST, "nearest")
ADD_ENUM(SELECT_TOOL_INRANGE, "inRange")
ADD_ENUM(SELECT_TOOL_INRANGESOFT, "inRangeSoft")
ADD_ENUM(SELECT_TOOL_GROW, "grow")
ADD_ENUM(SELECT_TOOL_SHRINK, "shrink")
IMPLEMENT_ENUM_END("select-tool")

IMPLEMENT_ENUM_BEGIN(eSelectType)
ADD_ENUM(SELECT_TYPE_SET, "set")
ADD_ENUM(SELECT_TYPE_ADD, "add")
ADD_ENUM(SELECT_TYPE_SUBSTRACT, "substract")
ADD_ENUM(SELECT_TYPE_UNSET, "unset")
IMPLEMENT_ENUM_END("select-type")

IMPLEMENT_ENUM_BEGIN(eMeshType)
ADD_ENUM(MESH_TRIANGLE, "triangle")
ADD_ENUM(MESH_DIAMOND, "diamond")
IMPLEMENT_ENUM_END("mesh-type")
