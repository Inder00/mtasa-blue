...
IMPLEMENT_ENUM_BEGIN(eShadowType)
ADD_ENUM(SHADOW_CAR, "car")
ADD_ENUM(SHADOW_PED, "ped")
ADD_ENUM(SHADOW_HELI, "heli")
ADD_ENUM(SHADOW_BIKE, "bike")
ADD_ENUM(SHADOW_RCBARON, "rcbaron")
ADD_ENUM(SHADOW_EXPLOSION, "explosion")
ADD_ENUM(SHADOW_HEADLIGHT1, "headlight1")
ADD_ENUM(SHADOW_HEADLIGHT2, "headlight2")
ADD_ENUM(SHADOW_BLOOD, "blood")
ADD_ENUM(SHADOW_HEADMAN, "headman")
ADD_ENUM(SHADOW_WINCRACK, "wincrack")
ADD_ENUM(SHADOW_LAMP, "lamp")
IMPLEMENT_ENUM_END("shadow-type")
