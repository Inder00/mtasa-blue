...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int /*nShowCmd*/)
{
    ...
    HWND hwnd;
    {
        ...
        hwnd = CreateWindowExW(WS_EX_OVERLAPPEDWINDOW, winClass.lpszClassName, L"02. Drawing a Triangle", WS_OVERLAPPEDWINDOW | WS_VISIBLE, CW_USEDEFAULT,
                               CW_USEDEFAULT, initialWidth, initialHeight, 0, 0, hInstance, 0);
    ...
    ID3D11DeviceContext1* d3d11DeviceContext;
    {
        ...
        HRESULT hResult = D3D11CreateDevice(0, D3D_DRIVER_TYPE_HARDWARE, 0, creationFlags, featureLevels, ARRAYSIZE(featureLevels), D3D11_SDK_VERSION,
                                            &baseDevice, 0, &baseDeviceContext);
        if (FAILED(hResult))
        {
    ...
    ID3D11InputLayout* inputLayout;
    {
        ...
        HRESULT hResult =
            d3d11Device->CreateInputLayout(inputElementDesc, ARRAYSIZE(inputElementDesc), vsBlob->GetBufferPointer(), vsBlob->GetBufferSize(), &inputLayout);
        assert(SUCCEEDED(hResult));
        vsBlob->Release();
    }
    ...
    UINT          offset;
    {
        float vertexData[] = {// x, y, r, g, b, a
                              0.0f, 0.5f, 0.f, 1.f, 0.f, 1.f, 0.5f, -0.5f, 1.f, 0.f, 0.f, 1.f, -0.5f, -0.5f, 0.f, 0.f, 1.f, 1.f};
...
{
    printf("asdf1");
    WinMain(GetModuleHandle(nullptr), nullptr, "", 0);
    printf("asdf2");
    Sleep(999999);
}
