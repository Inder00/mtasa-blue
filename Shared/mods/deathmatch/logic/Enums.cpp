...
IMPLEMENT_ENUM_BEGIN(eEventsFilter)
ADD_ENUM(EVENT_ON_ELEMENT_CLICKED, "onElementClicked")
ADD_ENUM(EVENT_ON_PLAYER_CLICK, "onPlayerClick")
ADD_ENUM(EVENT_ON_PLAYER_TARGET, "onPlayerTarget")
IMPLEMENT_ENUM_END("event-name")
